...
# @return [String]
def repository_slug
  ENV.fetch("REPOSITORY_SLUG", "rubykube/applogic")
end
...
def bump_from_master_branch
  # Get latest version of Applogic.
...
# updates version at lib/applogic/version.rb,
...
#
# Loads all Applogic tags, and returns them in ascending order.
#
...
#
# Loads all Applogic branches, selects only version-specific, and returns them.
#
# @return [Array<Hash>]
